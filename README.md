...
[![GitHub Stars](https://img.shields.io/github/stars/ankit-21310/CashSathi?style=for-the-badge&logo=github)](https://github.com/ankit-21310/CashSathi/stargazers)

🌐 **Try it Live:** [https://cashsathi-web.vercel.app/](https://cashsathi-web.vercel.app/)

🎥 **Demo Video:** [Watch on YouTube](https://www.youtube.com/watch?v=ISX4NwNZ68A)
...
or provider responses, and secrets.
...
- `services/api`: FastAPI service, Gemini orchestration, policy engine, integrations, and Firestore repositories.
- `infra`: Firebase rules and indexes, Cloud Build, Cloud Run, Scheduler, monitoring, CI, and smoke-test tooling.
...
claim launch completion. Genuine customer evidence, production verification, event registration, and external submission remain operator responsibilities.
